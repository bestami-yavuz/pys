...
@Entity
@Table(name = "PYS_PERSONEL_DONEM_TBL")
public class PersonelDonem {
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "PERS_DONEM_ID")
    ...
    @Column(name = "DEG_DURUMU")
    private Byte degDurumu = 0;

    @Column(name = "KAYIT_TIPI")
    private Byte kayitTipi = 0;
    ...
    public Byte getDegDurumu() { return degDurumu; }
    public void setDegDurumu(Byte degDurumu) { this.degDurumu = degDurumu; }
    public Byte getKayitTipi() { return kayitTipi; }
    public void setKayitTipi(Byte kayitTipi) { this.kayitTipi = kayitTipi; }
    ...
    public String getTelCep() { return telCep; }
    public void setTelCep(String telCep) { this.telCep = telCep; }
}
